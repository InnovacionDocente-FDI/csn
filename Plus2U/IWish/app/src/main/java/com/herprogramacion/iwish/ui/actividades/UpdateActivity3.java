...
public class UpdateActivity3 extends AppCompatActivity {
    ...
    private static final String TAG = UpdateActivity3.class.getSimpleName();
    private String idAsignatura;
    private String contPositivos;
    private String[] xData = { "Total", "Tú" };
    ...
    private void cargarDatos() {
        ...
        String newURL = Constantes.RANKING_TOTAL + "?idMeta=" + idAsignatura;

        // Consultar el detalle de la meta
        VolleySingleton.getInstance(UpdateActivity3.this).addToRequestQueue(
        ...
        try {
            ...
            switch (estado) {
                ...
                case "2":
                    ...
                    // Mostrar mensaje
                    Toast.makeText(
                            UpdateActivity3.this,
                            mensaje,
                            Toast.LENGTH_LONG).show();
                    // Enviar código de falla
                    UpdateActivity3.this.setResult(Activity.RESULT_CANCELED);
                    // Terminar actividad
                    UpdateActivity3.this.finish();
                    break;
            }
    ...
    private void cargarViews(Estadistica meta) {
        ...
        mChart.setDescription("Tú frente al Total");
        ...
        entradas.add(new Entry(Integer.parseInt(meta.getTotal()), 0));
