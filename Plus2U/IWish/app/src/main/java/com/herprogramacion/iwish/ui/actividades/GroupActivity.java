...
import com.herprogramacion.iwish.ui.fragmentos.GroupFragment;
...
public class GroupActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idPositivoGrupal = getIntent().getExtras().getString(Constantes.ID_POS_GRUPO);
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.container, GroupFragment.createInstance(user, idPositivoGrupal), "GroupFragment")
                    .commit();
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Constantes.CODIGO_DETALLE || requestCode == 3) {
            if (resultCode == RESULT_OK || resultCode == 203) {
                GroupFragment fragment = (GroupFragment) getSupportFragmentManager().
                        findFragmentByTag("GroupFragment");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camara) {
            try {
                Intent intent = new Intent(GroupActivity.this, InsertActivity.class);
