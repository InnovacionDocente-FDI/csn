...
/**
 * Fragmento principal que contiene la lista de las asignaturas
 */
public class MainFragment extends Fragment {
    ...
    public static MainFragment createInstance(String user) {
   ...
   public void cargarAdaptador(String mail) {
       ...
       String newURL = Constantes.GET_BY_ID + "?email=" + mail;
        ...
        try {
            ...
            switch (estado) {
                case "1": // EXITO
                    ...
                    adapter = new MetaAdapter(Arrays.asList(metas), getActivity(), extra);
